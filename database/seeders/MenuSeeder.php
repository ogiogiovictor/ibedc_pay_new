...
class MenuSeeder extends Seeder
{
     ...
     */
     ...
     protected $array = [
        ...
        [
            "menu_name" => "View Transaction",
            "menu_url" => "view_transactions",
            "menu_status" =>  "on",
            "menu_icon" => "",
            "menu_side" => "inner"
        ],
        ...
        [
            "menu_name" => "View Access Logs",
            "menu_url" => "view_access_log",
            "menu_status" =>  "on",
            "menu_icon" => "",
            "menu_side" => "inner"
        ],
        ...
        [
            "menu_name" => "Agency Transactions",
            "menu_url" => "agency_transaction",
            "menu_status" =>  "on",
            "menu_icon" => "",
            "menu_side" => "inner"
        ],
