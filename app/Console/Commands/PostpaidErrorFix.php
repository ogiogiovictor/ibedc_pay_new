...
class PostpaidErrorFix extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:postpaid-error-fix';
     ...
     * @var string
     */
    protected $description = 'Fixing Postpaid Error';
                    ...
                    foreach($prepaidpayments as $paymentLog){
                        ...
                        $data = [
                            ...
                            if(isset($user->email) && $user->email != "" &&  $user->email != "null"){
                                Mail::to($paymentLog->email)->cc($user->email)->send(new PostPaidMailConfirmation($paymentLog->customer_name, $paymentLog->email, 
                                $paymentLog->amount, $paymentLog->providerRef, $paymentLog->transaction_id));
                            }
