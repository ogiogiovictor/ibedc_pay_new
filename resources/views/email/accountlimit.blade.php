      ...
      <tr>
        ...
        <td class="container">
          ...
          <table style="width:100%;max-width:620px;margin:0 auto;">
            ...
            <span class="preheader">NEW ACCOUNT SETUP NOTIFICATION</span>
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
              ...
              <tr>
                <td class="wrapper">
                 ...
                 <p>
                    The customer with the details provided below requires additional accounts to be created under their profile. 
                    Kindly approve the request for an increase in the customer’s accounts.
                </p>

                    <br>Tracking ID :  <b>{{ $tracking_id }} </b>  <br/>
                    <br>Name :  <b>{{ $name }} </b>  <br/>
                    <br>Email :  <b>{{ $email }} </b>  <br/>
                    <br>Region :  <b>{{ $region }} </b>  <br/>
                    <br>Address :  <b>{{ $full_address }} </b>  <br/>
                    <br>Business Hub :  <b>{{ $business_hub }} </b>  <br/>
                    <br>Service Center :  <b>{{ $service_center }} </b>  <br/>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">Copyright © <?php echo date('Y'); ?> IBEDCPAY. All rights reserved. </span>
