        ...
        <td class="container">
          ...
          <table style="width:100%;max-width:200px;margin:0 auto;">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
              ...
              <tr>
                <td class="wrapper">
                  <p>Hi {{ $surname }} {{ $firstname }} {{ $other_name }}</p>
                  <p>We're thrilled to confirm that an account number has been created for you.</p><br/>
                  <p>Account Details:</p>
                      ...
                      <tr>
                        <td align="left">
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                              <tr>
                                <td> <h3>Tracking ID  {{ $tracking_id }}</h3> </td>
                              </tr>
                              <tr>
                                <td> <h3>Region  {{ $region }}</h3> </td>
                              </tr>
                              <tr>
                                <td>  <h3>Business Hub  {{ $business_hub }}</h3>  </td>
                              </tr>
                              ...
                              <tr>
                                <td> <p> With this account number, you can conveniently pay all your bills using IBEDCpay. We warmly welcome you once again and believe you will continue to be a valued customer.

                                    To apply for a meter immediately using your account number, please use this link: https://msms.ibedc.com/map/

                                    <br/>
                                  <a href="https://msms.ibedc.com/map/">Apply for Meter</a>
                                  </p> </td>
                              </tr>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">Copyright © <?php echo date('Y'); ?> IBEDC PAY. All rights reserved. </span>
