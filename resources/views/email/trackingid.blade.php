        ...
        <td class="container">
          ...
          <table style="width:100%;max-width:620px;margin:0 auto;">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
              ...
              <tr>
                <td class="wrapper">
                  <p>Hi {{ $title }} {{ $surname }} {{ $firstname }} {{ $other_name }}</p>
                  <div style="text-align:justify">
                 <p>Warm greetings from Ibadan Electricity Distribution Company (IBEDC)!</p>

                    <p>Thank you for choosing to request for an account number  with IBECPay, your one-stop solution for effortless bill payments and seamless energy management. 
